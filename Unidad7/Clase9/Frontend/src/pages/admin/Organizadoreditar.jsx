...
const OrganizadorEditar = () => {
    ...
    useEffect(() => {
        ...
        Service.obtenerOrganizador(codigo)
        .then(response => {
            console.log(response)
            setNombre(response.organizador.nombre);
            setCorreo(response.organizador.correo);
            setContrasenia(response.organizador.contrasenia);
        })
    },[]);
    ...
    const handleConfirmar = () => {
        ...
        Service.editarOrganizador(codigo,data)
        .then(response => {
            console.log(response)
            navigate("/admin/organizadores")
        })
    ...
    return (
        <form class="max-w-md mx-auto mt-28" type="submit" onSubmit={handleSubmit}>
            <h1 className="text-3xl mb-5">Editar Organizador</h1>
            ...
            <button 
                ...
                onChange={handleCancelar}
            >Cancelar</button>
        </form>
    )
}

export default OrganizadorEditar;